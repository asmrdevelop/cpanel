 ...
 * License: MIT
 */!function(e){var t={};function n(r){if(t[r])return t[r].exports;var i=t[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,n),i.loaded=!0,i.exports}n.m=e,n.c=t,n.p="",n(0)}([function(e,t,n){"use strict";var r=l(n(1)),i=l(n(2)),o=l(n(3)),a=l(n(4)),u=l(n(6));function l(e){return e&&e.__esModule?e:{default:e}}angular.module("ui.scroll",[]).service("jqLiteExtras",(function(){return new r.default})).run(["jqLiteExtras",function(e){return window.jQuery?null:e.registerFor(angular.element)}]).directive("uiScrollViewport",(function(){return{restrict:"A",controller:["$scope","$element",function(e,t){var n=this;return this.container=t,this.viewport=t,this.scope=e,angular.forEach(t.children(),(function(e){"tbody"===e.tagName.toLowerCase()&&(n.viewport=angular.element(e))})),this}]}})).directive("uiScroll",["$log","$injector","$rootScope","$timeout","$q","$parse",function(e,t,n,r,l,s){return{require:["?^uiScrollViewport"],restrict:"A",transclude:"element",priority:1e3,terminal:!0,link:function(e,c,f,d,h){var p=f.uiScroll.match(/^\s*(\w+)\s+in\s+([(\w|\$)\.]+)\s*$/);if(!p)throw new Error("Expected uiScroll in form of '_item_ in _datasource_' but got '"+f.uiScroll+"'");function g(t,n){var r=s(t)(e);return isNaN(r)?n:r}var m=null,v=p[1],b=p[2],y=d[0],x=Math.max(3,g(f.bufferSize,10)),w=Math.max(.3,g(f.padding,.5)),E=g(f.startIndex,1),P=0,j=[],S=new i.default(t,l),T=new o.default(S,x),$=new a.default(S,T,c,y,n,w),I=new u.default($,T,W,_,f,s,c,e);y&&(y.adapter=I);var A=function(){return angular.isObject(m)&&angular.isFunction(m.get)};if(!(m=s(b)(e),A()||(m=t.get(b),A())))throw new Error(b+" is not a valid datasource");var V={};function O(e,t,n){var i=Object.getOwnPropertyDescriptor(e,t);i&&(i.set||i.get)||Object.defineProperty(e,t,{set:function(e){V[t]=e,r((function(){if(T[n]=e,!j.length){var r=$.topDataPos();$.adjustPadding(),"minIndex"===t&&$.adjustScrollTopAfterMinIndexSet(r)}}))},get:function(){return V[t]}})}O(m,"minIndex","minIndexUser"),O(m,"maxIndex","maxIndexUser");var k=2!==m.get.length?function(e){return m.get(T.next,x,e)}:function(e){m.get({index:T.next,append:T.length?T[T.length-1].item:void 0,count:x},e)},C=2!==m.get.length?function(e){return m.get(T.first-x,x,e)}:function(e){m.get({index:T.first-x,prepend:T.length?T[0].item:void 0,count:x},e)};function L(t){return t&&t!==P||e.$$destroyed}function M(){$.unbind("resize",Z),$.unbind("scroll",Z)}function _(){$.resetTopPadding(),$.resetBottomPadding(),arguments.length&&(E=arguments[0]),T.reset(E),W()}function H(e){return e.element.height()&&e.element[0].offsetParent}function U(e,t){D(e,t,$.insertElement),H(e)||(e.unregisterVisibilityWatcher=e.scope.$watch((function(){return function(e){H(e)&&(T.forEach((function(e){angular.isFunction(e.unregisterVisibilityWatcher)&&(e.unregisterVisibilityWatcher(),delete e.unregisterVisibilityWatcher)})),j.length||W())}(e)}))),e.element.addClass("ng-hide")}function D(e,t,n){var r=null,i=t>0?T[t-1].element:void 0;return h((function(t,o){r=n(t,i),e.element=t,e.scope=o,o[v]=e.item})),I.transform&&I.transform(e.scope,e.element),r}function B(){var e=[],t=[],n=[],r=[];return T.forEach((function(i,o){switch(i.op){case"prepend":t.unshift(i);break;case"append":U(i,o),i.op="none",r.push(i);break;case"insert":e=e.concat(D(i,o,$.insertElementAnimated)),i.op="none",r.push(i);break;case"remove":n.push(i)}})),n.forEach((function(t){return e=e.concat(T.remove(t))})),t.length&&t.forEach((function(e){U(e),e.op="none"})),T.forEach((function(e,t){return e.scope.$index=T.first+t})),{prepended:t,removed:n,inserted:r,animated:e}}function F(e,t){t.animated.length?l.all(t.animated).then((function(){$.adjustPadding(),W(e)})):$.adjustPadding()}function N(e,t){$.shouldLoadBottom()?(!t||T.effectiveHeight(t.inserted)>0)&&1===j.push(!0)&&(z(e),I.loading(!0)):$.shouldLoadTop()&&(!t||T.effectiveHeight(t.prepended)>0||j[0])&&1===j.push(!1)&&(z(e),I.loading(!0))}function W(e){e||(j=[],e=++P);var t=B();r((function(){t.inserted.forEach((function(e){return e.element.removeClass("ng-hide")})),t.prepended.forEach((function(e){return e.element.removeClass("ng-hide")})),L(e)||(F(e,t),N(e),j.length||I.calculateProperties())}))}function q(e){var t=B();r((function(){t.inserted.forEach((function(e){return e.element.removeClass("ng-hide")})),t.prepended.forEach((function(e){return e.element.removeClass("ng-hide")})),$.adjustScrollTopAfterPrepend(t),L(e)||(F(e,t),N(e,t),j.shift(),j.length?z(e):(I.loading(!1),$.bind("resize",Z),$.bind("scroll",Z),I.calculateProperties()))}))}function z(e){j[0]?T.length&&!$.shouldLoadBottom()?q(e):k((function(t){L(e)||(t.length<x&&(T.eof=!0),t.length>0&&($.clipTop(),T.append(t)),q(e))})):T.length&&!$.shouldLoadTop()?q(e):C((function(t){L(e)||(t.length<x&&(T.bof=!0),t.length>0&&(T.length&&$.clipBottom(),T.prepend(t)),q(e))}))}function Z(){n.$$phase||I.isLoading||I.disabled||(N(P),j.length?M():(I.calculateProperties(),e.$apply()))}function R(e){if(!I.disabled){var t=$[0].scrollTop,n=$[0].scrollHeight-$[0].clientHeight;(0===t&&!T.bof||t===n&&!T.eof)&&e.preventDefault()}}h((function(e,t){$.createPaddingElements(e[0]),t.$destroy(),e.remove()})),e.$on("$destroy",(function(){M(),$.unbind("mousewheel",R)})),$.bind("mousewheel",R),r((function(){$.applyContainerStyle(),_()}))}}}])},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=function(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return function(e,t){var n=[],r=!0,i=!1,o=void 0;try{for(var a,u=e[Symbol.iterator]();!(r=(a=u.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(e){i=!0,o=e}finally{try{!r&&u.return&&u.return()}finally{if(i)throw o}}return n}(e,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")},r=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();
/*!
