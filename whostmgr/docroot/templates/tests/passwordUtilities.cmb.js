...
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+sql+ini+git&plugins=line-numbers+autolinker */
...
define("app/script/prism", function(){});

/* global define: false, Prism: false */

define(
    'app/directives/prismDirective',[
        "angular",
        "app/script/prism"
    ],
    function(angular) {
         ...
         * Usage
         *
         * <pre ng-prism language="css">
         * body {
         *    color: red;
         * }
         * </pre>
         *
         * the files prismjs and prism css must be included in HTML, use any of the following languages:
         *  markup
         *  javascript
         *  css
         *  bash
        ...
        app.directive("ngPrism", [ function() {
            ...
            return {
                ...
                link: function(scope, el, attrs, model) {
                    ...
                    if (attrs.language) {
                        el.addClass("language-" + attrs.language);
                    }

                    model.$render = function() {
                        el.html(model.$viewValue);
...
/*
# templates/tests/views/passwordViewController.js Copyright(c) 2020 cPanel, L.L.C.
#                                                           All rights reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
        ...
        var controller = app.controller(
            ...
            ["$scope", "$rootScope", "alertService",
                function($scope, $location, alertService) {
                    ...
                    $scope.state = "Click 'Show State' button to update:";
                    $scope.displayState = function(form) {
                        $scope.state = "form = " + JSON.stringify(form,
                            function(key, value) {
                                if (key === "$parsers" || key === "$formatters") {
                                    return undefined;
                                }
...
/*
# templates/tests/passwordUtilities.js            Copyright(c) 2020 cPanel, L.L.C.
#                                                           All rights reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
                ...
                app.config(["$routeProvider", "$locationProvider",
                    function($routeProvider, $locationProvider) {
                        ...
                        $routeProvider.when("/password", {
                            ...
                            templateUrl: CJT.buildFullPath("tests/views/passwordView.ptt"),
                            breadcrumb: "Password Tests",
                            reloadOnSearch: false
                        });

                        $routeProvider.otherwise({
                            redirectTo: function(routeParams, path, search) {
                                return "/password?" + window.location.search;
                            }
                        });
                    }
                ]);
