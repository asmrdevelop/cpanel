    ...
    function(CJT, LOCALE) {
        ...
        var ROUTES = [
            ...
            },
            {
                ...
                "hideTitle": true,
                "title": LOCALE.maketext("View the [output,acronym,DKIM,DomainKeys Identified Mail] Private Key"),
                "resolve": {
                    "initialDomains": ["DomainsService", function($service) {
                        return $service.fetchAll();
                    }]
...
define(
    ...
    function(angular, ROUTES) {
        ...
        var MODULE_NAMESPACE = "whm.emailDeliverability.controllers.route";
        var MODULE_REQUIREMENTS = [];
        var CONTROLLER_NAME = "RouteController";
        var CONTROLLER_INJECTABLES = ["$scope", "$rootScope", "$location", "alertService", "PAGE"];

        var CONTROLLER = function RouteController($scope, $rootScope, $location, $alertService, PAGE) {
