...
if ('/usr/local/cpanel/3rdparty/php/83/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/usr/local/cpanel/3rdparty/php/83/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
