...
#            }gemx;
   ...
   $doc->prune( sub { $_[1]->isa('PPI::Token::Comment') || $_[1]->isa('PPI::Token::Pod') } );
   ...
   if ($self->{optimise_size}) {
      # these usually decrease size, but decrease compressability more
       for my $node (@{ $doc->find (sub {  $_[1]->isa('PPI::Structure::Block') || $_[1]->isa('PPI::Structure::Condition') || $_[1]->isa('PPI::Structure::List') } ) }) {
