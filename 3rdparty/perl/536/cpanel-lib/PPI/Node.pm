...
sub find {
  ...
  # Bypass the warnings about PPI classes that have
  # been deprecated 8+ years ago since they are expensive
  # and are not found anywhere in our codebase.
  local *PPI::Structure::List::isa;
  local *PPI::Structure::For::isa;
