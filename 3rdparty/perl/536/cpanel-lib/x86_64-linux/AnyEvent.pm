...
our $_sig_name_init; $_sig_name_init = sub {
   eval q{ # poor man's autoloading {}
      undef $AnyEvent::Base::_sig_name_init;
...
sub signal {
   eval q{ # poor man's autoloading {}
      ...
      if (_have_async_interrupt) {
         ...
         $AnyEvent::Base::SIGPIPE_R = new Async::Interrupt::EventPipe;
         $AnyEvent::Base::SIG_IO = AE::io $AnyEvent::Base::SIGPIPE_R->fileno, 0, \&_signal_exec;
         ...
         if (AnyEvent::WIN32) {
            ...
            ($AnyEvent::Base::SIGPIPE_R, $AnyEvent::Base::SIGPIPE_W) = AnyEvent::Util::portable_pipe ();
            AnyEvent::Util::fh_nonblocking ($AnyEvent::Base::SIGPIPE_R, 1) if $AnyEvent::Base::SIGPIPE_R;
            AnyEvent::Util::fh_nonblocking ($AnyEvent::Base::SIGPIPE_W, 1) if $AnyEvent::Base::SIGPIPE_W; # just in case
         } else {
            pipe $AnyEvent::Base::SIGPIPE_R, $AnyEvent::Base::SIGPIPE_W;
            fcntl $AnyEvent::Base::SIGPIPE_R, AnyEvent::F_SETFL, AnyEvent::O_NONBLOCK if $AnyEvent::SIGPIPE_R;
            fcntl $AnyEvent::Base::SIGPIPE_W, AnyEvent::F_SETFL, AnyEvent::O_NONBLOCK if $AnyEvent::Base::SIGPIPE_W; # just in case

            # not strictly required, as $^F is normally 2, but let's make sure...
            fcntl $AnyEvent::Base::SIGPIPE_R, AnyEvent::F_SETFD, AnyEvent::FD_CLOEXEC;
            fcntl $AnyEvent::Base::SIGPIPE_W, AnyEvent::F_SETFD, AnyEvent::FD_CLOEXEC;
         }

         $AnyEvent::Base::SIGPIPE_R
            or Carp::croak "AnyEvent: unable to create a signal reporting pipe: $!\n";

         $AnyEvent::SIG_IO = AE::io $AnyEvent::Base::SIGPIPE_R, 0, \&_signal_exec;
      }

      *signal = $AnyEvent::Base::HAVE_ASYNC_INTERRUPT
         ? sub {
              my (undef, %arg) = @_;

              # async::interrupt
              my $signal = sig2num $arg{signal};
              $AnyEvent::Base::SIG_CB{$signal}{$arg{cb}} = $arg{cb};

              $AnyEvent::Base::SIG_ASY{$signal} ||= new Async::Interrupt
                 cb             => sub { undef $AnyEvent::Base::SIG_EV{$signal} },
                 signal         => $signal,
                 pipe           => [$AnyEvent::Base::SIGPIPE_R->filenos],
                 pipe_autodrain => 0,
              ;
         ...
         : sub {
              ...
              $SIG{$signal} ||= sub {
                 local $!;
                 syswrite $AnyEvent::Base::SIGPIPE_W, "\x00", 1 unless %AnyEvent::Base::SIG_EV;
                 undef $AnyEvent::Base::SIG_EV{$signal};
              };
      ...
      *AnyEvent::Base::signal::DESTROY = sub {
         ...
         delete $AnyEvent::Base::SIG_CB{$signal}{$cb};

         $AnyEvent::Base::HAVE_ASYNC_INTERRUPT
            ? delete $AnyEvent::Base::SIG_ASY{$signal}
            : # delete doesn't work with older perls - they then
              ...
              undef $SIG{$signal}
            unless keys %{ $AnyEvent::Base::SIG_CB{$signal} };
      };

      *_signal_exec = sub {
         $AnyEvent::Base::HAVE_ASYNC_INTERRUPT
            ? $AnyEvent::SIGPIPE_R->drain
            : sysread $AnyEvent::SIGPIPE_R, (my $dummy), 9;

         while (%AnyEvent::Base::SIG_EV) {
            for (keys %AnyEvent::Base::SIG_EV) {
               delete $AnyEvent::Base::SIG_EV{$_};
               &$_ for values %{ $AnyEvent::Base::SIG_CB{$_} || {} };
            }
         }
      };
   };
...
sub child {
   eval q{ # poor man's autoloading {}
      ...
      *child = sub {
         ...
         $AnyEvent::Base::PID_CB{$pid}{$cb+0} = $cb;

         unless ($AnyEvent::Base::CHLD_W) {
            $AnyEvent::Base::CHLD_W = AE::signal CHLD => \&_sigchld;
      ...
      *AnyEvent::Base::child::DESTROY = sub {
         ...
         delete $AnyEvent::Base::PID_CB{$pid}{$icb};
         delete $AnyEvent::Base::PID_CB{$pid} unless keys %{ $AnyEvent::Base::PID_CB{$pid} };

         undef $AnyEvent::Base::CHLD_W unless keys %AnyEvent::Base::PID_CB;
      };
   };
   die if $@;
...
CHECK{ AnyEvent->now } # Force detection at BEGIN time.
1;
