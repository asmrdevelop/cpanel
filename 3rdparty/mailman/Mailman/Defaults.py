...
# Allow original attachment filename extensions for potentially executable
# scripts (PHP, etc.)
SCRUBBER_ALLOW_SCRIPT_EXTENSION = False
...
PYTHON          = '/usr/local/cpanel/3rdparty/bin/python2'
PREFIX          = '/usr/local/cpanel/3rdparty/mailman'
EXEC_PREFIX     = '${prefix}'
VAR_PREFIX      = '/usr/local/cpanel/3rdparty/mailman'
...
# If our template override directory exists, we'll try to load
# templates from there instead of the regular place.
if os.path.isdir('/var/cpanel/templates/mailman'):
    TEMPLATE_DIR = '/var/cpanel/templates/mailman'
