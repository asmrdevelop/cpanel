...
def guess_extension(ctype, ext):
    ...
    try:
        allow = mm_cfg.SCRUBBER_ALLOW_SCRIPT_EXTENSION
    except AttributeError:
        allow = False;
    if (not allow) and (ctype in ["text/php", "text/x-php", "application/php", "application/x-php", "application/x-httpd-php", "application/x-httpd-php-source"]):
        return ".bin"
