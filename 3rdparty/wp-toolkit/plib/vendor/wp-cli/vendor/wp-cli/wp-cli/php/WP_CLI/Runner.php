...
class Runner {
    ...
    private function prepare_config_code( $wp_config_path ) {
        ...
        $wp_config_content = preg_replace( '/\s*\?\>\s*$/', '', $wp_config_content );
        $wp_config_content = preg_replace("/(is_admin\(\))/", 'false', $wp_config_content);
        $wp_config_content = preg_replace(
            ...
            $count);
        if ($count > 0) {
            $wp_config_content = $wp_config_content . PHP_EOL .
                'function fake_filter($arg1 = null, $arg2 = null, $arg3 = null, $arg4 = null) {' . PHP_EOL .
                '    return;' . PHP_EOL .
                '}' . PHP_EOL;
        }
