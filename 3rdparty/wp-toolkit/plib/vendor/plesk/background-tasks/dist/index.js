...
var uiLibrary = require('@plesk/ui-library');
...
var BackgroundTaskItem = function (_Component) {
    ...
    function BackgroundTaskItem() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = BackgroundTaskItem.__proto__ || Object.getPrototypeOf(BackgroundTaskItem)).call.apply(_ref, [this].concat(args))), _this), _this.renderStatusIcon = function (task) {
            if (!isBackgroundTaskCompleted(task)) {
                return react.createElement(uiLibrary.Icon, { name: 'reload', animation: 'spin', intent: 'info' });
            }
            if (isBackgroundTaskFailed(task)) {
                return react.createElement(uiLibrary.Icon, { name: 'cross-mark-circle-filled', intent: 'danger' });
            }
            if (task.errors.length > 0) {
                return react.createElement(uiLibrary.Icon, { name: 'check-mark-circle-filled', intent: 'warning' });
            }
            return react.createElement(uiLibrary.Icon, { name: 'check-mark-circle-filled', intent: 'success' });
            ...
            if (!isBackgroundTaskCompleted(task)) {
                ...
                return react.createElement(
                    ...
                    null,
                    task.title,
                    react.createElement(uiLibrary.ProgressStep, { className: baseClassName + '__progress-bar', progress: task.progress, status: task.status }),
                    react.createElement(
                        'div',
                        { className: baseClassName + '__progress-footer' },
                        hasSteps && react.createElement(
                            'div',
                            ...
                            react.createElement(
                                ...
                                react.createElement(uiLibrary.Translate, { content: 'backgroundTasks.showDetails', fallback: 'show details' })
                            )
                        ),
                        react.createElement(uiLibrary.Translate, {
            ...
            return react.createElement(uiLibrary.Action, { icon: 'cross-mark', onClick: function onClick() {
                    return onClose(task);
                } });
    ...
    createClass(BackgroundTaskDetails, [{
        ...
        value: function render() {
            ...
            Object.keys(task.steps).forEach(function (stepCode) {
                ...
                var progressStep = react.createElement(
                    uiLibrary.ProgressStep,
                    {
                        key: stepCode,
                        title: step.title,
                        status: step.status,
            ...
            return react.createElement(
                uiLibrary.Dialog,
                {
                    actions: [react.createElement(
                        ...
                        react.createElement(uiLibrary.Translate, { content: 'backgroundTasks.minimizeDetails', fallback: 'minimize' })
                    )],
                    className: baseClassName,
                    title: task.title,
                    size: 'xs',
                ...
                this.isErrorsVisible() && react.createElement(
                    uiLibrary.Alert,
    ...
    function BackgroundTasksComponent(props) {
        ...
        _this.renderHideCompletedAction = function (hasSeveralStatusesOrTasks) {
            ...
            return react.createElement(
                ...
                react.createElement(uiLibrary.Translate, { content: 'backgroundTasks.hideCompleted', fallback: 'Hide completed' })
            );
        };
        ...
        _this.renderTitle = function () {
            ...
            if (runningTasksCount > 0) {
                runningTasksTitle = react.createElement(
                    react.Fragment,
                    null,
                    react.createElement(uiLibrary.Icon, { className: baseClassName + '__title__icon', name: 'reload', animation: 'spin', intent: 'info' }),
                    react.createElement(uiLibrary.Translate, {
            ...
            if (doneTasksCount > 0) {
                doneTasksTitle = react.createElement(
                    react.Fragment,
                    null,
                    react.createElement(uiLibrary.Icon, { className: baseClassName + '__title__icon', name: 'check-mark-circle-filled', intent: 'success' }),
                    react.createElement(uiLibrary.Translate, {
            ...
            if (warningTasksCount > 0) {
                warningTasksTitle = react.createElement(
                    react.Fragment,
                    null,
                    react.createElement(uiLibrary.Icon, { className: baseClassName + '__title__icon', name: 'check-mark-circle-filled', intent: 'warning' }),
                    react.createElement(uiLibrary.Translate, {
            ...
            if (failedTasksCount > 0) {
                failedTasksTitle = react.createElement(
                    react.Fragment,
                    null,
                    react.createElement(uiLibrary.Icon, { className: baseClassName + '__title__icon', name: 'cross-mark-circle-filled', intent: 'danger' }),
                    react.createElement(uiLibrary.Translate, {
        ...
        _this.renderTaskDetails = function () {
            ...
            return react.createElement(BackgroundTaskDetails, {
                task: task,
                ...
                react.createElement(
                    ...
                    react.createElement(
                        ...
                        react.createElement(
                            ...
                            isCollapsed ? react.createElement(uiLibrary.Icon, { name: 'chevron-up', intent: 'info' }) : react.createElement(uiLibrary.Icon, { name: 'chevron-down', intent: 'info' })
                        ),
                        this.renderTitle()
                    ),
                    react.createElement(
                        ...
                        react.createElement(
                            ...
                            tasks.sort(function (taskA, taskB) {
                                ...
                                return react.createElement(
                                    ...
                                    react.createElement(BackgroundTaskItem, { task: task, onClose: _this2.handleCloseItem, onShowDetails: _this2.handleOpenDetails })
                                );
                            })
                        )
                    )
...
var BackgroundTasks = reactRedux.connect(mapStateToProps, mapDispatchToProps)(BackgroundTasksComponent);
...
exports.backgroundTasksMiddleware = backgroundTasksMiddleware;
exports.getBackgroundTasksReducer = getBackgroundTasksReducer;
exports.isBackgroundTaskCompleted = isBackgroundTaskCompleted;
exports.isBackgroundTaskDone = isBackgroundTaskDone;
exports.isBackgroundTaskFailed = isBackgroundTaskFailed;
exports.getBackgroundTask = getBackgroundTask;
exports.convertStepsForProgressInDrawer = convertStepsForProgressInDrawer;
exports.getIntent = getIntent;
exports.fetchBackgroundTask = fetchBackgroundTask;
exports.fetchBackgroundTasks = fetchBackgroundTasks;
exports.removeBackgroundTask = removeBackgroundTask;
exports.removeCompletedBackgroundTasks = removeCompletedBackgroundTasks;
exports.pollBackgroundTasks = pollBackgroundTasks;
