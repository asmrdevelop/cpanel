...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-tr.js
// Module:    legacy_cjt/cpanel-all-tr
// Locale:    tr
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Gelişmiş Seçenekler","Alpha Characters":"Alfabetik Karakterler","An unknown error occurred.":"Bilinmeyen bir hata oluştu.","Both":"Her ikisi","Cancel":"İptal","Click to close.":"Kapatmak için tıklayın.","Close":"Kapat","Generate Password":"Şifre Oluştur","I have copied this password in a safe place.":"Bu şifreyi güvenli bir yere kopyaladım.","Length":"Uzunluk","Loading …":"Yükleniyor…","Lowercase":"Küçük harf","Non Alpha Characters":"Alfabe Dışı Karakterler","Numbers":"Rakamlar","OK":"Tamam","Password Generator":"Şifre Oluşturucu","Password Strength":"Şifre Gücü","Password cannot be empty.":"Şifre boş olamaz.","Password strength must be at least [numf,_1].":"Şifre gücü en az [numf,_1] olmalıdır.","Passwords Match":"Şifreler Eşleşiyor","Passwords do not match.":"Şifreler eşleşmiyor.","Passwords must be at least [quant,_1,character,characters] long.":"Şifreler en az [quant,_1,karakter,karakter] uzunluğunda olmalıdır.","Strong":"Güçlü","Success!":"Başarılı!","Symbols":"Semboller","The API response could not be parsed.":"API yanıtı ayrıştırılamadı.","Uppercase":"Büyük harf","Use Password":"Şifre Kullan","Validation Errors":"Doğrulama Hataları","Very Strong":"Çok Güçlü","Very Weak":"Çok Zayıf","Weak":"Zayıf","less »":"daha az »","more »":"daha fazla »","unlimited":"sınırsız"};
