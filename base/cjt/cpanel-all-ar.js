...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-ar.js
// Module:    legacy_cjt/cpanel-all-ar
// Locale:    ar
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"الخيارات المتقدمة","Alpha Characters":"حروف ألفا","An unknown error occurred.":"حدث خطأ غير معروف.","Both":"كلاهما","Cancel":"الإلغاء","Click to close.":"انقر للإغلاق.","Close":"الإغلاق","Generate Password":"إنشاء كلمة المرور","I have copied this password in a safe place.":"لقد قمت بنسخ كلمة المرور هذه في مكان آمن.","Length":"الطول","Loading …":"جارٍ التحميل …","Lowercase":"أحرف صغيرة","Non Alpha Characters":"لا توجد حروف ألفا","Numbers":"الأعداد","OK":"موافق","Password Generator":"منشئ كلمة المرور","Password Strength":"قوة كلمة المرور","Password cannot be empty.":"لا يمكن أن تكون كلمة المرور فارغة.","Password strength must be at least [numf,_1].":"يجب أن تكون قوة كلمة المرور على الأقل [numf,_1].","Passwords Match":"تطابق كلمات مرور","Passwords do not match.":"لا تتطابق كلمات المرور.","Passwords must be at least [quant,_1,character,characters] long.":"يجب أن يكون طول كلمات المرور على الأقل [quant,_1,حرفًا,حرفًا].","Strong":"قوية","Success!":"عملية ناجحة!","Symbols":"الرموز","The API response could not be parsed.":"تعذر توزيع استجابة API.","Uppercase":"أحرف كبيرة","Use Password":"استخدام كلمة المرور","Validation Errors":"أخطاء التحقق من الصحة","Very Strong":"قوية جدًا","Very Weak":"ضعيفة جدًا","Weak":"ضعيف","less »":"أقل من »","more »":"المزيد »","unlimited":"غير محدودة"};
