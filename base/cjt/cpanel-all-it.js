...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-it.js
// Module:    legacy_cjt/cpanel-all-it
// Locale:    it
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Opzioni avanzate","Alpha Characters":"Caratteri alfabetici","An unknown error occurred.":"Si è verificato un errore sconosciuto.","Both":"Entrambi","Cancel":"Annulla","Click to close.":"Fare clic per chiudere.","Close":"Chiudi","Generate Password":"Genera password","I have copied this password in a safe place.":"Ho copiato questa password in un luogo sicuro.","Length":"Lunghezza","Loading …":"Caricamento in corso…","Lowercase":"Minuscolo","Non Alpha Characters":"Caratteri non alfabetici","Numbers":"Numeri","OK":"OK","Password Generator":"Generatore password","Password Strength":"Sicurezza password","Password cannot be empty.":"Il campo Password non può essere vuoto.","Password strength must be at least [numf,_1].":"Il livello di sicurezza della password deve essere almeno [numf,_1].","Passwords Match":"Le password coincidono","Passwords do not match.":"Le password non corrispondono.","Passwords must be at least [quant,_1,character,characters] long.":"La lunghezza delle password deve essere almeno pari a [quant,_1,carattere,caratteri].","Strong":"Sicura","Success!":"Operazione completata","Symbols":"Simboli","The API response could not be parsed.":"Impossibile analizzare la risposta API.","Uppercase":"Maiuscolo","Use Password":"Usa password","Validation Errors":"Errori convalida","Very Strong":"Molto sicura","Very Weak":"Molto vulnerabile","Weak":"Vulnerabile","less »":"meno »","more »":"altro »","unlimited":"illimitato"};
