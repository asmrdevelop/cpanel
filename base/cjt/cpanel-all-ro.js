...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-ro.js
// Module:    legacy_cjt/cpanel-all-ro
// Locale:    ro
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Opţiuni avansate","Alpha Characters":"Caractere alfanumerice","An unknown error occurred.":"A intervenit o eroare necunoscută.","Both":"Ambele","Cancel":"Revocare","Click to close.":"Faceţi clic pentru închidere.","Close":"Închidere","Generate Password":"Generare de parole","I have copied this password in a safe place.":"Am copiat această parolă într-un loc sigur.","Length":"Lungime","Loading …":"Se încarcă…","Lowercase":"Litere mici","Non Alpha Characters":"Caractere non-alfanumerice","Numbers":"Numere","OK":"OK","Password Generator":"Generator de parole","Password Strength":"Putere parolă","Password cannot be empty.":"Parola nu poate fi goală.","Password strength must be at least [numf,_1].":"Puterea parolei trebuie să fie cel puţin [numf,_1].","Passwords Match":"Parolele se potrivesc","Passwords do not match.":"Parolele nu se potrivesc.","Passwords must be at least [quant,_1,character,characters] long.":"Frazele de acces trebuie să aibă cel puţin [quant,_1,caracter,caractere].","Strong":"Puternică","Success!":"Succes!","Symbols":"Simboluri","The API response could not be parsed.":"Răspunsul API nu a fost analizat.","Uppercase":"Majuscule","Use Password":"Utilizare parolă","Validation Errors":"Erori de validare","Very Strong":"Foarte puternic","Very Weak":"Foarte slab","Weak":"Slab","less »":"mai puţin »","more »":"mai mult »","unlimited":"nelimitat"};
