...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-zh.js
// Module:    legacy_cjt/cpanel-all-zh
// Locale:    zh
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"高级选项","Alpha Characters":"字母字符","An unknown error occurred.":"发生未知错误。","Both":"二者","Cancel":"取消","Click to close.":"单击以关闭。","Close":"关闭","Generate Password":"生成密码","I have copied this password in a safe place.":"我已在安全的位置复制此密码。","Length":"长度","Loading …":"正在加载…","Lowercase":"小写字母","Non Alpha Characters":"非字母字符","Numbers":"数字","OK":"确定","Password Generator":"密码生成器","Password Strength":"密码强度","Password cannot be empty.":"密码不能为空。","Password strength must be at least [numf,_1].":"密码强度必须至少为 [numf,_1]。","Passwords Match":"密码匹配","Passwords do not match.":"密码不匹配。","Passwords must be at least [quant,_1,character,characters] long.":"密码长度至少为 [quant,_1,个字符,个字符]。","Strong":"强","Success!":"成功!","Symbols":"符号","The API response could not be parsed.":"无法解析 API 响应。","Uppercase":"大写字母","Use Password":"使用密码","Validation Errors":"验证错误","Very Strong":"非常强","Very Weak":"非常弱","Weak":"弱","less »":"更少 »","more »":"更多信息 »","unlimited":"无限制"};
