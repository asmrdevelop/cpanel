...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-ja.js
// Module:    legacy_cjt/cpanel-all-ja
// Locale:    ja
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"高度なオプション","Alpha Characters":"英字","An unknown error occurred.":"不明なエラーが発生しました。","Both":"両方","Cancel":"キャンセル","Click to close.":"クリックして閉じます。","Close":"閉じる","Generate Password":"パスワードを生成","I have copied this password in a safe place.":"安全な場所にパスワードをコピーしました。","Length":"長さ","Loading …":"ロード中 …","Lowercase":"小文字","Non Alpha Characters":"英字以外","Numbers":"Numbers","OK":"OK","Password Generator":"パスワード生成","Password Strength":"パスワード強度","Password cannot be empty.":"パスワードは空にできません。","Password strength must be at least [numf,_1].":"パスワードの強度は、[numf,_1] 以上である必要があります。","Passwords Match":"パスワード一致","Passwords do not match.":"パスワードが一致しません。","Passwords must be at least [quant,_1,character,characters] long.":"パスワードの長さは、[quant,_1,文字,文字]以上である必要があります。","Strong":"強い","Success!":"成功！","Symbols":"記号","The API response could not be parsed.":"API応答を解析できませんでした。","Uppercase":"大文字","Use Password":"パスワードを使用","Validation Errors":"検証エラー","Very Strong":"非常に強い","Very Weak":"非常に弱い","Weak":"弱い","less »":"縮小 »","more »":"拡大 »","unlimited":"無制限"};
