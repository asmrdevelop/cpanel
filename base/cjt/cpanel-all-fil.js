...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-fil.js
// Module:    legacy_cjt/cpanel-all-fil
// Locale:    fil
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Mga Advanced na Opsyon","Alpha Characters":"Mga Alpha Character","An unknown error occurred.":"May naganap na hindi alam na error.","Both":"Pareho","Cancel":"Kanselahin","Click to close.":"I-click upang isara.","Close":"Isara","Generate Password":"Buuin ang Password","I have copied this password in a safe place.":"Kinopya ko ang password na ito sa isang ligtas na lugar.","Length":"Haba","Loading …":"Naglo-load …","Lowercase":"Lowercase","Non Alpha Characters":"Mga Non Alpha Character","Numbers":"Mga Bilang","OK":"OK","Password Generator":"Password Generator","Password Strength":"Tatag ng Password","Password cannot be empty.":"Hindi maaaring walang laman ang password.","Password strength must be at least [numf,_1].":"Ang tibay ng password ay dapat na hindi bababa sa [numf,_1].","Passwords Match":"Magkatugma ang Mga Password","Passwords do not match.":"Hindi magkatugma ang mga password.","Passwords must be at least [quant,_1,character,characters] long.":"Hindi dapat bababa sa [quant,_1,character,(na) character] ang haba ng password.","Strong":"Matatag","Success!":"Tagumpay!","Symbols":"Mga Simbolo","The API response could not be parsed.":"Hindi ma-parse ang API response.","Uppercase":"Uppercase","Use Password":"Gamitin ang Password","Validation Errors":"Mga Error sa Pagpapatunay","Very Strong":"Napakatibay","Very Weak":"Napakahina","Weak":"Mahina","less »":"mas kaunti »","more »":"higit pa »","unlimited":"walang limitasyon"};
