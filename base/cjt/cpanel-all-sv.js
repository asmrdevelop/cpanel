...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-sv.js
// Module:    legacy_cjt/cpanel-all-sv
// Locale:    sv
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Avancerade alternativ","Alpha Characters":"Alfatecken","An unknown error occurred.":"Ett okänt fel inträffade.","Both":"Både","Cancel":"Avbryt","Click to close.":"Klicka om du vill stänga.","Close":"Stäng","Generate Password":"Generera lösenord","I have copied this password in a safe place.":"Jag har kopierat lösenordet och sparat det på en säker plats.","Length":"Längd","Loading …":"Läser in …","Lowercase":"Gemener","Non Alpha Characters":"Ej alfatecken","Numbers":"Tal","OK":"OK","Password Generator":"Lösenordsgenerator","Password Strength":"Lösenordsstyrka","Password cannot be empty.":"Lösenord måste anges.","Password strength must be at least [numf,_1].":"Lösenordsstyrkan måste vara minst [numf,_1].","Passwords Match":"Lösenorden överensstämmer","Passwords do not match.":"Lösenorden överensstämmer inte.","Passwords must be at least [quant,_1,character,characters] long.":"Lösenord måste innehålla minst [quant,_1,tecken,tecken].","Strong":"Starkt","Success!":"Klart.","Symbols":"Symboler","The API response could not be parsed.":"API-svaret gick inte att tolka.","Uppercase":"Versaler","Use Password":"Använd lösenord","Validation Errors":"Valideringsfel","Very Strong":"Mycket starkt","Very Weak":"Mycket svag","Weak":"Svagt","less »":"mindre »","more »":"mer »","unlimited":"obegränsat"};
