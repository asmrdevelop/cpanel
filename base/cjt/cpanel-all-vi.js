...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-vi.js
// Module:    legacy_cjt/cpanel-all-vi
// Locale:    vi
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Tùy Chọn Nâng Cao","Alpha Characters":"Ký Tự Chữ","An unknown error occurred.":"Xảy ra lỗi lạ.","Both":"Cả Hai","Cancel":"Hủy","Click to close.":"Bấm để đóng.","Close":"Đóng","Generate Password":"Tạo Mật Khẩu","I have copied this password in a safe place.":"Tôi đã sao mật khẩu này vào nơi an toàn.","Length":"Độ Dài","Loading …":"Đang tải …","Lowercase":"Chữ thường","Non Alpha Characters":"Ký Tự Không Phải Là Chữ","Numbers":"Số","OK":"OK","Password Generator":"Bộ Tạo Mật Khẩu","Password Strength":"Độ Mạnh Mật Khẩu","Password cannot be empty.":"Không được để trống mật khẩu.","Password strength must be at least [numf,_1].":"Độ mạnh mật khẩu phải ít nhất [numf,_1].","Passwords Match":"Mật Khẩu Giống Nhau","Passwords do not match.":"Mật khẩu không giống nhau.","Passwords must be at least [quant,_1,character,characters] long.":"Mật khẩu phải dài ít nhất [quant,_1,ký tự,ký tự].","Strong":"Mạnh","Success!":"Thành Công!","Symbols":"Ký Hiệu","The API response could not be parsed.":"Không phân tích được hồi đáp API.","Uppercase":"Chữ Hoa","Use Password":"Dùng Mật Khẩu","Validation Errors":"Lỗi Xác Thực","Very Strong":"Rất Mạnh","Very Weak":"Rất Yếu","Weak":"Yếu","less »":"thu gọn »","more »":"thêm »","unlimited":"không giới hạn"};
