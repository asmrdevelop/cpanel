...
// Generated: /usr/local/cpanel/base/cjt/cpanel-all-nl.js
// Module:    legacy_cjt/cpanel-all-nl
// Locale:    nl
...
(function() {
    // The raw lexicon.
    var newLex = {"Advanced Options":"Geavanceerde opties","Alpha Characters":"Alfabettekens","An unknown error occurred.":"Er is een onbekende fout opgetreden.","Both":"Beide","Cancel":"Annuleren","Click to close.":"Klik om te sluiten.","Close":"Sluiten","Generate Password":"Wachtwoord genereren","I have copied this password in a safe place.":"Ik heb dit wachtwoord gekopieerd naar een veilige plaats.","Length":"Lengte","Loading …":"Bezig met laden…","Lowercase":"Kleine letters","Non Alpha Characters":"Geen alfabettekens","Numbers":"Getallen","OK":"OK","Password Generator":"Wachtwoordgenerator","Password Strength":"Wachtwoordsterkte","Password cannot be empty.":"Wachtwoord kan niet leeg zijn.","Password strength must be at least [numf,_1].":"De wachtwoordsterkte moet ten minste [numf,_1] zijn.","Passwords Match":"Wachtwoorden komen overeen","Passwords do not match.":"Wachtwoorden komen niet overeen.","Passwords must be at least [quant,_1,character,characters] long.":"Wachtwoorden moeten ten minste [quant,_1,teken,tekens] lang zijn.","Strong":"Sterk","Success!":"Geslaagd.","Symbols":"Symbolen","The API response could not be parsed.":"Het API-antwoord kan niet worden geparseerd.","Uppercase":"Hoofdletters","Use Password":"Wachtwoord gebruiken","Validation Errors":"Validatiefouten","Very Strong":"Zeer sterk","Very Weak":"Zeer zwak","Weak":"Zwak","less »":"minder »","more »":"meer »","unlimited":"onbeperkt"};
