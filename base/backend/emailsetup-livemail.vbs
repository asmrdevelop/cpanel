...
' *************************************************************************
strIncServerAddress	   = "%inc_host%"		 					' This is the address for the mail server
strOutServerAddress	   = "%out_host%"		 					' This is the address for the mail server
strServerMailPort 	   = "%mailPort%"							' The port on the server to which to connect
																' Imap:  Secure = 000003e1  Unsecure = 0000008f
																' Pop:   Secure = 000003e3	Unsecure = 0000006e
strAccount			   = "%account%"							' Mail account to connect as
strSecureConnection    = "%secureConnection%"					' Use a secure connection - 00000001 for true, 00000000 for false
strCloseText 		   = "%closeText%"
strFolderNotFoundText  = "%dirNotFoundText%"
strProgramNotFoundText = "%programNotFoundText%"
strFileNotFoundText	   = "%fileNotFoundText%"
strServerSmtpPort	   = "%smtpPort%"							' Smtp port on the server
boolPop				   = %popEnabled%							' Whether to setup Imap or Pop
boolArchive			   = %archiveEnabled%						' Whether or not to use the special folders
