...
require_once 'libraries/cpanel_interface.lib.php';
        ...
        if (strlen($db) > 0 && (! empty($_POST['db_rename']) || ! empty($_POST['db_copy']))) {
            ...
            if (! isset($_POST['newname']) || strlen($_POST['newname']) === 0) {
                ...
                if ($_POST['newname'] === $_REQUEST['db']) {
                    ...
                    /* ensure cPanel DB name prefix is effected as soon as possible */
                    $_POST['newname'] = _PMA_CPANEL_addPrefixIfNeeded( $_POST['newname'] );
                    $_error = false;
                    ...
                    if (! $_error && $move) {
                        ...
                        $cp_drop_results = PMA_CPANEL_API_deldb($db);
                        $sql_query .= "\n" . $cp_drop_results['sql_query'];
                        unset($cp_drop_results);
