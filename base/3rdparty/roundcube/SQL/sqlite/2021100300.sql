...
DROP INDEX IF EXISTS ix_contactgroups_user_id;
...
DROP INDEX IF EXISTS ix_contactgroupmembers_contact_id;
...
DROP INDEX IF EXISTS ix_identities_user_id;
DROP INDEX IF EXISTS ix_identities_email;
...
DROP INDEX IF EXISTS ix_responses_user_id;
...
DROP INDEX IF EXISTS ix_dictionary_user_language;
...
DROP INDEX IF EXISTS ix_searches_user_type_name;
...
DROP INDEX IF EXISTS ix_filestore_user_id;
