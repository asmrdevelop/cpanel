...
$config['markasjunk_spam_cmd'] = '/usr/local/cpanel/3rdparty/bin/sa-learn --spam --username=%u %f';
...
$config['markasjunk_ham_cmd'] = '/usr/local/cpanel/3rdparty/bin/sa-learn --ham --username=%u %f';
