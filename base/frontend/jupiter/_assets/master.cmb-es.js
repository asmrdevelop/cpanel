...
// Generated: /usr/local/cpanel/base/frontend/jupiter/_assets/master.cmb-es.js
// Module:    /jupiter/_assets/master.cmb-es
// Locale:    es
...
(function() {
    // The raw lexicon.
    var newLex = {"[quant,_1,%s byte,%s bytes]":"[quant,_1,%s bytes,%s bytes,%s bytes,%s bytes,%s bytes,%s bytes]"};
