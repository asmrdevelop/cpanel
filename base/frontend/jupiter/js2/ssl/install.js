/*
# cpanel - base/frontend/jupiter/js2/ssl/install.js
...
/* jshint esnext:true */
/* eslint-disable camelcase, no-empty, no-use-before-define */
...
*/
    ...
    function make_primary_click_listener(e) {
        ...
        var callback = _make_overlay_and_callback({
            progress_html: LOCALE.maketext("Setting “[_1]” as the primary SSL host …", servername.html_encode()),
            success_html: LOCALE.maketext("“[_1]” is now the primary SSL host.", servername.html_encode()),
        }).callback;
    ...
    if (!DEDICATED_IP) {
        ...
        new CPANEL.widgets.Page_Notice({
            ...
            level: "warn",
            content: LOCALE.maketext("[output,strong,Note:] You don’t have a dedicated IP address. Browsers that were released before 2013 may not support [output,abbr,SNI,Server Name Indication]. Because of this, users may see false security warnings when they visit your SSL-secured websites."),
        });
        /* jshint +W031 */
    }
