...
function du_callback(api_return) {
    ...
    var non_home_labels = ['<a title="' + LANG.see_mysql + '" href="../sql/index.html">Databases</a>'];
    ...
    build_divs("Databases", "/frontend/" + window.thisTheme + "/sql/index.html", mysql_usage);
    if (has_postgres) {
    ...
    build_divs(mailaccounts_html, "/frontend/" + window.thisTheme + "/email_accounts/index.html", mailaccounts_usage, LEXICON.mail_note);
