...
package Cpanel::Plugins::Components::YAML;
...
C<Cpanel::Plugins::Components::YAML>

=head1 DESCRIPTION

C<Cpanel::Plugins::Components::YAML> is a Component class used to load Components from a YAML file format.
...
sub BUILD {
    my ( $self, $args ) = @_;
    my $content   = File::Slurper::read_text( $args->{path} ) or die "Cannot load component yaml file: $args->{path}";
    my $component = YAML::Tiny::Load($content);
