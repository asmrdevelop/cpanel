package Cpanel::Security::Policy::PasswordAge::UI::Text;

# cpanel - Cpanel/Security/Policy/PasswordAge/UI/Text.pm
...
sub process {
    ...
    Cpanel::SecurityPolicy::UI::text_header();
    Cpanel::SecurityPolicy::UI::process_template( 'PasswdAge/main.txt.tmpl', \%template_vars );
