package Cpanel::SSL::Parsed::CSR;

# cpanel - Cpanel/SSL/Parsed/CSR.pm                Copyright 2022 cPanel, L.L.C.
#                                                           All rights reserved.
...
L<Cpanel::SSL::Utils>’s C<parse_csr_text()> returns.
