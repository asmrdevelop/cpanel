...
$Cpanel::CPAN::Locales::DB::Language::hr::VERSION = '0.09';

$Cpanel::CPAN::Locales::DB::Language::hr::cldr_version = '2.0';

%Cpanel::CPAN::Locales::DB::Language::hr::misc_info = (
...
$Cpanel::CPAN::Locales::DB::Language::hr::misc_info{cldr_formats}{list_or} = {
  'end' => '{0} ili {1}',
  'middle' => '{0}, {1}',
  'start' => '{0}, {1}',
  '2' => '{0} ili {1}'
