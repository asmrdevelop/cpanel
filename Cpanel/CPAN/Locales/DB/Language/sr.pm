...
$Cpanel::CPAN::Locales::DB::Language::sr::VERSION = '0.09';

$Cpanel::CPAN::Locales::DB::Language::sr::cldr_version = '2.0';

%Cpanel::CPAN::Locales::DB::Language::sr::misc_info = (
...
$Cpanel::CPAN::Locales::DB::Language::sr::misc_info{cldr_formats}{list_or} = {
  'middle' => '{0}, {1}',
