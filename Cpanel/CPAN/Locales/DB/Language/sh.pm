package Cpanel::CPAN::Locales::DB::Language::sh;
...
$Cpanel::CPAN::Locales::DB::Language::sh::VERSION = '0.09';

$Cpanel::CPAN::Locales::DB::Language::sh::cldr_version = '2.0';

%Cpanel::CPAN::Locales::DB::Language::sh::misc_info = (
...
$Cpanel::CPAN::Locales::DB::Language::sh::misc_info{cldr_formats}{list_or} = {
  '2' => '{0} or {1}',
  'start' => '{0}, {1}',
  'middle' => '{0}, {1}',
  'end' => '{0}, or {1}'
