...
$Cpanel::CPAN::Locales::DB::Language::bs::VERSION = '0.09';

$Cpanel::CPAN::Locales::DB::Language::bs::cldr_version = '2.0';

%Cpanel::CPAN::Locales::DB::Language::bs::misc_info = (
...
$Cpanel::CPAN::Locales::DB::Language::bs::misc_info{cldr_formats}{list_or} = {
  'start' => '{0}, {1}',
  '2' => '{0} ili {1}',
  'middle' => '{0}, {1}',
  'end' => '{0} ili {1}'
