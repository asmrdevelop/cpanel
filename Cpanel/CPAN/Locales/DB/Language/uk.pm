package Cpanel::CPAN::Locales::DB::Language::uk;
...
$Cpanel::CPAN::Locales::DB::Language::uk::VERSION = '0.09';

$Cpanel::CPAN::Locales::DB::Language::uk::cldr_version = '2.0';

%Cpanel::CPAN::Locales::DB::Language::uk::misc_info = (
...
$Cpanel::CPAN::Locales::DB::Language::uk::misc_info{cldr_formats}{list_or} = {
  'start' => '{0}, {1}',
  '2' => "{0} \x{d0}\x{b0}\x{d0}\x{b1}\x{d0}\x{be} {1}",
  'middle' => '{0}, {1}',
  'end' => "{0} \x{d0}\x{b0}\x{d0}\x{b1}\x{d0}\x{be} {1}"
};
