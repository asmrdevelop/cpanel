package Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::Consider;
...
sub normalize_maketext_string {
    ...
    my $struct = Cpanel::CPAN::Locale::Maketext::Utils::Phrase::phrase2struct( ${$string_sr} );

    # entires phrase is bracket notation
    if ( Cpanel::CPAN::Locale::Maketext::Utils::Phrase::struct_is_entirely_bracket_notation($struct) ) {
    ...
    my $bn_var_rexep  = Cpanel::CPAN::Locale::Maketext::Utils::Phrase::get_bn_var_regexp();
    ...
    for my $piece ( @{$struct} ) {
        ...
        if ( $piece->{'type'} eq 'complex' ) {
            ...
            for my $frag ( @arg_list[ 1 .. $#arg_list ] ) {
                if ( $frag eq '' ) {
                    $new_bn =~ s{
                        ($Cpanel::CPAN::Locale::Maketext::Utils::Phrase::bn_delimit)
                        (
                            $Cpanel::CPAN::Locale::Maketext::Utils::Phrase::bn_delimit
                            |
                            $Cpanel::CPAN::Locale::Maketext::Utils::Phrase::closing_bn
                        )
                    }{$1EMPTY STRING$2}x;
