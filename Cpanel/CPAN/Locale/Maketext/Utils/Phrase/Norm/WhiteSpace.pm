package Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::WhiteSpace;
...
(and the beginning if it starts with an L<ellipsis|Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::Ellipsis>).
