package Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::Ampersand;
...
Same rationale as the L<Markup|Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::Markup/Rationale>.
...
… THIS FILTER L<Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Norm::Markup>.
