package Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core;
...
sub get_core_lex {
    ...
    for my $core_phrase ( keys %Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core::Lexicon ) {
        $my_lexicon->{$core_phrase} = $lh->get_asset(
            sub {
                my $ns = "Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core::$_[0]";
        ...
        $my_lexicon->{$core_phrase} ||= $Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core::Lexicon{$core_phrase};
    }
...
# = USAGE
#
# =head2 Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core::get_core_lex($lh)
#
# =head2 Cpanel::CPAN::Locale::Maketext::Utils::Phrase::Core::get_core_lex($lh, $specific_locale_tag)
#
# = TRANSLATIONS
#
# = LEXICON
