...
Cpanel::CPAN::I18N::LangTags - functions for dealing with RFC3066-style language tags
...
...or specify whichever of those functions you want to import, like so:
  ...
  use Cpanel::CPAN::I18N::LangTags qw(implicate_supers similarity_language_tag);
...
say:
    ...
    use Cpanel::CPAN::I18N::LangTags qw(:ALL)

...then all are exported.  (This saves you from having to use
something less obvious like C<use Cpanel::CPAN::I18N::LangTags qw(/./)>.)

If you don't import any of these functions, assume a C<&Cpanel::CPAN::I18N::LangTags::>
...
You could instead do lookups on $wanted with:
          ...
          use Cpanel::CPAN::I18N::LangTags qw(same_language_tag);
          my $repsonse = '';
...
program with:
          ...
          use Cpanel::CPAN::I18N::LangTags qw(encode_language_tag);
          my %greetings;
          die unless open(IN, "<in.dat");
          while(<IN>) {
            chomp;
...
This function is most useful in the idiom
  ...
  implicate_supers( Cpanel::CPAN::I18N::LangTags::Detect::detect() );

(See L<Cpanel::CPAN::I18N::LangTags::Detect>.)
...
In some future version of Cpanel::CPAN::I18N::LangTags, I plan to include support
...
* L<Cpanel::CPAN::I18N::LangTags::List|Cpanel::CPAN::I18N::LangTags::List>
