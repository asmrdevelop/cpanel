package Cpanel::CPAN::I18N::LangTags::List;

# cpanel -  Cpanel/CPAN/I18N/LangTags/List.pm        Copyright 2022 cPanel, L.L.C.
#                                                           All rights reserved.
...
#----------------------------------------------------------------------
{
    ...
    my ( $disrec, $tag, $name );
    my $last_name = '';
    while (<Cpanel::CPAN::I18N::LangTags::List::DATA>) {
        if ($seeking) {
            $seeking = 0 if m/=for woohah/;
        }
        elsif ( ( $disrec, $tag, $name ) = m/(\[?)\{([-0-9a-zA-Z]+)\}(?:\s*:)?\s*([^\[\]]+)/ ) {
            $name =~ s/\s*[;\.]*\s*$//g;
            next unless $name;
            ++$count;
            print "<$tag> <$name>\n" if $Debug;
...
sub is_decent {
    ...
    shift @supers if $supers[0] =~ m<^([ix]|sgn)$>s;
    return 0 unless @supers;
...
Cpanel::CPAN::I18N::LangTags::List -- tags and names for human languages

=head1 SYNOPSIS

  use Cpanel::CPAN::I18N::LangTags::List;
  print "Parlez-vous... ", join(', ',
      Cpanel::CPAN::I18N::LangTags::List::name('elx') || 'unknown_language',
      Cpanel::CPAN::I18N::LangTags::List::name('ar-Kw') || 'unknown_language',
      Cpanel::CPAN::I18N::LangTags::List::name('en') || 'unknown_language',
      Cpanel::CPAN::I18N::LangTags::List::name('en-CA') || 'unknown_language',
    ), "?\n";
...
C<Cpanel::CPAN::I18N::LangTags::List::name( I<langtag> ) > that takes
a language tag (see L<Cpanel::CPAN::I18N::LangTags|Cpanel::CPAN::I18N::LangTags>)
and returns the best attempt at an English name for it, or
undef if it can't make sense of the tag.

The function Cpanel::CPAN::I18N::LangTags::List::name(...) is not exported.

This module also provides a function
C<Cpanel::CPAN::I18N::LangTags::List::is_decent( I<langtag> )> that returns true iff
...
%Cpanel::CPAN::I18N::LangTags::List::Name, and it's the same as the list
...
L<Cpanel::CPAN::I18N::LangTags|Cpanel::CPAN::I18N::LangTags> and its "See Also" section.
