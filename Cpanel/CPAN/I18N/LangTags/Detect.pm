...
sub http_accept_langs {
    ...
    # Hm.  Should I just move this into Cpanel::CPAN::I18N::LangTags at some point?
    no integer;
...
Cpanel::CPAN::I18N::LangTags::Detect - detect the user's language preferences

=head1 SYNOPSIS

  use Cpanel::CPAN::I18N::LangTags::Detect;
  my @user_wants = Cpanel::CPAN::I18N::LangTags::Detect::detect();
...
C<Cpanel::CPAN::I18N::LangTags::Detect::detect()>.  This function is not exported
...
C<Cpanel::CPAN::I18N::LangTags::implicate_supers_tightly(...)>
or
C<Cpanel::CPAN::I18N::LangTags::implicate_supers(...)>, like so:

  my @languages =
    Cpanel::CPAN::I18N::LangTags::implicate_supers_tightly(
      Cpanel::CPAN::I18N::LangTags::Detect::detect()
    );
...
L<Cpanel::CPAN::I18N::LangTags>, L<Win32::Locale>, L<Locale::Maketext>.
