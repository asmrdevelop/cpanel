package Cpanel::Hulkd::QueuedTasks::BlockBruteForce;

# cpanel - Cpanel/Hulkd/QueuedTasks/BlockBruteForce.pm
...
sub _DIR {
    return '/var/cpanel/taskqueue/groups/cphulk_block_brute_force';
}
