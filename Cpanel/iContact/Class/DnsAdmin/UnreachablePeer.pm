package Cpanel::iContact::Class::DnsAdmin::UnreachablePeer;

# cpanel - Cpanel/iContact/Class/DnsAdmin/UnreachablePeer.pm
...
sub _get_cluster_status_url {
    ...
    return 'https://' . $self->{'_opts'}{'url_host'} . ':2087/scripts7/clusterstatus';
}
