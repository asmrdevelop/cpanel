package Cpanel::Database::MariaDB::MariaDB101;

# cpanel - Cpanel/Database/MariaDB/MariaDB101.pm Copyright 2022 cPanel, L.L.C.
#                                                           All rights reserved.
...
use constant {
    ...
    short_version       => '101',
    item_short_version  => '10.1',
    selected_version    => 'MariaDB101',
    locale_version      => 'MariaDB 10.1',
    eol_time            => {
        start => 1445040000,
        end   => 1602910800
    },
    release_notes    => 'https://go.cpanel.net/changelog-mariadb101',
    default_sql_mode => 'NO_ENGINE_SUBSTITUTION,NO_AUTO_CREATE_USER',
    features         => [
        'Improved [asis,InnoDB] performance.',
        '[asis,UNION ALL]s can now be executed without a temporary table.',
    ],
...
Cpanel::Database::MariaDB::MariaDB101

=head1 SYNOPSIS

The database module for MariaDB 10.1

=head1 DESCRIPTION

This module contains all code and attributes unique to MariaDB 10.1
